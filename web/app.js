...
function wakeTick() {
  ...
  if (!inflight || waited < WAKE_AFTER) {
    bar.hidden = true;
    return;
  }
  bar.hidden = false;
  $('#waking-sec').textContent = `${Math.round(waited / 1000)}s`;
}
