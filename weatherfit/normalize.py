...
_OUTDOOR_HINT = [
    ...
    "캠핑", "해변", "전망대", "거리축제", "야시장", "산책로", "등산",
    "궁", "능", "성곽", "고궁", "노천", "야경", "퍼레이드", "플리마켓",
]
_INDOOR_HINT = [
    "박물관", "미술관", "전시관", "기념관", "도서관", "체육관", "실내",
    "카페", "레스토랑", "백화점", "쇼핑몰", "지하상가", "면세점",
    "극장", "영화관", "공연장", "아트홀", "아쿠아리움", "찜질방", "스파",
    "문화센터", "복합문화공간", "갤러리", "서점", "공방",
]
_INDOOR_CATEGORIES = {"음식", "쇼핑", "숙박"}
